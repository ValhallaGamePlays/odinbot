...
class ItemClassifier 
{
	constructor() 
	{
		...
		this.inventoryProperties.itemName = "Regeneration Potion";
		this.inventoryProperties.description = "Temporary regeneration";
		this.inventoryProperties.helper = "+40 health for 5 turns";
		...
		this.behavior.consumed = function(account, message, sim, item, slot, inBattle) {
			...
			return "drank a regeneration potion! (+40 HP for 5 turns)";
		}
		...
		this.inventoryProperties.battleModifiers = [
			...
			//--==--==--==--==--==--==--==--==--==--==--==
			{
				...
				executor: function(sim,item,slot,member,mod) {
					...
					sim.accountManager.giveHealth(member.account,40,false);
				},
